...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.play_and_pause_link.setFixedSize(65, 28)
        self.rewind_link.setFixedSize(65, 28)
        self.speed_up_link.setFixedSize(65, 28)
        self.speed_down_link.setFixedSize(65, 28)
        ...
        self.radar_play_and_pause_button = QPushButton()
        ...
        self.radar_play_and_pause_button.setFixedSize(40,30)
        self.radar_speed_up_button.setFixedSize(40,30)
        self.radar_speed_down_button.setFixedSize(40,30)
        self.radar_open_file_button.setFixedSize(40,30)
        self.radar_close_file_button.setFixedSize(40,30)
        self.radar_open_file_button.clicked.connect(self.browse_radar_file)
        self.radar_play_and_pause_button.clicked.connect(self.pause_radar)
        ...
        self.radar_play_and_pause_button.setEnabled(False)
        ...
        self.radar_play_and_pause_button.setIcon(self.pause_icon)
        ...
        self.radar_buttons.addWidget(self.radar_play_and_pause_button)
    ...
    def browse_radar_file(self):
        ...
        if file_path:
            ...
            self.radar_play_and_pause_button.setEnabled(True)
    ...
    def pause_radar(self):
        self.radar_play_and_pause_button.setIcon(self.play_icon)
        self.radar_play_and_pause_button.clicked.connect(self.play_radar)
        self.radar.pause_radar()
    
    def play_radar(self):
        self.radar_play_and_pause_button.setIcon(self.pause_icon)
        self.radar_play_and_pause_button.clicked.connect(self.pause_radar)
        self.radar.play_radar()
